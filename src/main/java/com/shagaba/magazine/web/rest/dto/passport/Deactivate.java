...
import com.shagaba.magazine.security.annotation.CurrentUsername;
...
public class Deactivate {
	...
	public String toString() {
		return String.format("Signup {username=%s, password=%s, emailAddress=%s}", username, password, emailAddress);
	}
