...
@Document
public class PersonalInformation extends AuditingDomain implements AccountIdentifiable<String> {
	...
	public String toString() {
		return String.format(
				"PersonalInformation {accountId=%s, displayName=%s, namePrefix=%s, firstName=%s, middleName=%s, lastName=%s, nameSuffix=%s, gender=%s, languageTag=%s, zoneId=%s, dateOfBirth=%s, maritalStatus=%s, addresses=%s, phones=%s, avatar=%s, theme=%s, occupation=%s, jobTitle=%s, interests=%s, hobbies=%s, company=%s, version=%s, createdBy=%s, createdTime=%s, lastModifiedBy=%s, lastModifiedTime=%s}",
				accountId, displayName, namePrefix, firstName, middleName, lastName, nameSuffix, gender, languageTag,
				zoneId, dateOfBirth, maritalStatus, addresses, phones, avatar, theme, occupation, jobTitle, interests,
				hobbies, company, version, createdBy, createdTime, lastModifiedBy, lastModifiedTime);
	}
